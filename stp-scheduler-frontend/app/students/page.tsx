...
export default function StudentsPage(){
    ...
    return (
        <div className="text-black">
            <h2 className=" text-end pr-48 mt-8 mb-2 text-lg"><b>{studentData.length}</b> Total Students</h2>
            <ul className="flex flex-wrap w-dvw justify-center list-decimal p-4">
